...
```bash
# Windows
aegis build examples/top-down-shooter --target win-x64

# Linux
aegis build examples/top-down-shooter --target linux-x64

# Publicar no itch.io
aegis publish examples/top-down-shooter --itch seunome/top-down-shooter --target win-x64
```
